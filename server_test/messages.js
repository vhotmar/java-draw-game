...
(function(global, factory) { /* global define, require, module */
    ...
    $root.ClientMessage = (function() {
        ...
        Object.defineProperty(ClientMessage.prototype, "message", {
            get: $util.oneOfGetter($oneOfFields = ["chooseWord", "clearCanvas", "draw", "chatMessage", "startGame", "connectMessage"]),
        ...
        ClientMessage.encode = function encode(message, writer) {
            ...
            if (message.chooseWord != null && Object.hasOwnProperty.call(message, "chooseWord"))
                $root.ClientMessage.ChooseWordMessage.encode(message.chooseWord, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.clearCanvas != null && Object.hasOwnProperty.call(message, "clearCanvas"))
                $root.ClientMessage.ClearCanvasMessage.encode(message.clearCanvas, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.draw != null && Object.hasOwnProperty.call(message, "draw"))
                $root.ClientMessage.DrawMessage.encode(message.draw, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.chatMessage != null && Object.hasOwnProperty.call(message, "chatMessage"))
                $root.ClientMessage.ChatMessage.encode(message.chatMessage, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.startGame != null && Object.hasOwnProperty.call(message, "startGame"))
                $root.ClientMessage.StartGameMessage.encode(message.startGame, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.connectMessage != null && Object.hasOwnProperty.call(message, "connectMessage"))
                $root.ClientMessage.ConnectMessage.encode(message.connectMessage, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            return writer;
        };
        ...
        ClientMessage.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1:
                    message.chooseWord = $root.ClientMessage.ChooseWordMessage.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.clearCanvas = $root.ClientMessage.ClearCanvasMessage.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.draw = $root.ClientMessage.DrawMessage.decode(reader, reader.uint32());
                    break;
                case 4:
                    message.chatMessage = $root.ClientMessage.ChatMessage.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.startGame = $root.ClientMessage.StartGameMessage.decode(reader, reader.uint32());
                    break;
                case 6:
                    message.connectMessage = $root.ClientMessage.ConnectMessage.decode(reader, reader.uint32());
                    break;
                default:
        ...
        ClientMessage.verify = function verify(message) {
            ...
            if (message.chooseWord != null && message.hasOwnProperty("chooseWord")) {
                ...
                {
                    var error = $root.ClientMessage.ChooseWordMessage.verify(message.chooseWord);
                    if (error)
                        return "chooseWord." + error;
                }
            }
            if (message.clearCanvas != null && message.hasOwnProperty("clearCanvas")) {
                if (properties.message === 1)
                    return "message: multiple values";
                properties.message = 1;
                {
                    var error = $root.ClientMessage.ClearCanvasMessage.verify(message.clearCanvas);
                    if (error)
                        return "clearCanvas." + error;
                }
            }
            ...
            if (message.chatMessage != null && message.hasOwnProperty("chatMessage")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ClientMessage.ChatMessage.verify(message.chatMessage);
                    if (error)
            ...
            if (message.startGame != null && message.hasOwnProperty("startGame")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ClientMessage.StartGameMessage.verify(message.startGame);
                    if (error)
            ...
            if (message.connectMessage != null && message.hasOwnProperty("connectMessage")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ClientMessage.ConnectMessage.verify(message.connectMessage);
                    if (error)
        ...
        ClientMessage.fromObject = function fromObject(object) {
            ...
            if (object.chooseWord != null) {
                ...
                message.chooseWord = $root.ClientMessage.ChooseWordMessage.fromObject(object.chooseWord);
            }
            if (object.clearCanvas != null) {
                if (typeof object.clearCanvas !== "object")
                    throw TypeError(".ClientMessage.clearCanvas: object expected");
                message.clearCanvas = $root.ClientMessage.ClearCanvasMessage.fromObject(object.clearCanvas);
            }
            if (object.draw != null) {
            ...
            if (object.chatMessage != null) {
                ...
                message.chatMessage = $root.ClientMessage.ChatMessage.fromObject(object.chatMessage);
            }
            if (object.startGame != null) {
                if (typeof object.startGame !== "object")
                    throw TypeError(".ClientMessage.startGame: object expected");
                message.startGame = $root.ClientMessage.StartGameMessage.fromObject(object.startGame);
            }
            if (object.connectMessage != null) {
                ...
                message.connectMessage = $root.ClientMessage.ConnectMessage.fromObject(object.connectMessage);
            }
            return message;
        };
        ...
        ClientMessage.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (message.chooseWord != null && message.hasOwnProperty("chooseWord")) {
                object.chooseWord = $root.ClientMessage.ChooseWordMessage.toObject(message.chooseWord, options);
                if (options.oneofs)
                    object.message = "chooseWord";
            }
            if (message.clearCanvas != null && message.hasOwnProperty("clearCanvas")) {
                object.clearCanvas = $root.ClientMessage.ClearCanvasMessage.toObject(message.clearCanvas, options);
                if (options.oneofs)
                    object.message = "clearCanvas";
            }
            if (message.draw != null && message.hasOwnProperty("draw")) {
                object.draw = $root.ClientMessage.DrawMessage.toObject(message.draw, options);
                if (options.oneofs)
                    object.message = "draw";
            }
            if (message.chatMessage != null && message.hasOwnProperty("chatMessage")) {
                object.chatMessage = $root.ClientMessage.ChatMessage.toObject(message.chatMessage, options);
                if (options.oneofs)
                    object.message = "chatMessage";
            }
            if (message.startGame != null && message.hasOwnProperty("startGame")) {
                object.startGame = $root.ClientMessage.StartGameMessage.toObject(message.startGame, options);
                if (options.oneofs)
                    object.message = "startGame";
            }
            if (message.connectMessage != null && message.hasOwnProperty("connectMessage")) {
                object.connectMessage = $root.ClientMessage.ConnectMessage.toObject(message.connectMessage, options);
                if (options.oneofs)
                    object.message = "connectMessage";
            }
            return object;
        };
        ...
        ClientMessage.ConnectMessage = (function() {
            ...
            ConnectMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientMessage.ConnectMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ConnectMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ClientMessage.ConnectMessage)
                    return object;
        ...
        ClientMessage.ChooseWordMessage = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            ChooseWordMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            ChooseWordMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientMessage.ChooseWordMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
        ...
        ClientMessage.ClearCanvasMessage = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            ClearCanvasMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            ClearCanvasMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientMessage.ClearCanvasMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
        ...
        ClientMessage.DrawMessage = (function() {
            ...
            DrawMessage.encode = function encode(message, writer) {
                ...
                if (message.commands != null && message.commands.length)
                    for (var i = 0; i < message.commands.length; ++i)
                        $root.DrawCommand.encode(message.commands[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                return writer;
            };
            ...
            DrawMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientMessage.DrawMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
                        if (!(message.commands && message.commands.length))
                            message.commands = [];
                        message.commands.push($root.DrawCommand.decode(reader, reader.uint32()));
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            DrawMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ClientMessage.DrawMessage)
                    return object;
                var message = new $root.ClientMessage.DrawMessage();
                if (object.commands) {
                    if (!Array.isArray(object.commands))
                        throw TypeError(".ClientMessage.DrawMessage.commands: array expected");
                    message.commands = [];
                    for (var i = 0; i < object.commands.length; ++i) {
                        if (typeof object.commands[i] !== "object")
                            throw TypeError(".ClientMessage.DrawMessage.commands: object expected");
                        message.commands[i] = $root.DrawCommand.fromObject(object.commands[i]);
                    }
                }
                return message;
            };
            ...
            DrawMessage.toObject = function toObject(message, options) {
                ...
                if (message.commands && message.commands.length) {
                    ...
                    for (var j = 0; j < message.commands.length; ++j)
                        object.commands[j] = $root.DrawCommand.toObject(message.commands[j], options);
                }
                return object;
            };
        ...
        ClientMessage.ChatMessage = (function() {
            ...
            ChatMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientMessage.ChatMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ChatMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ClientMessage.ChatMessage)
                    return object;
        ...
        ClientMessage.StartGameMessage = (function() {
            ...
            StartGameMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ClientMessage.StartGameMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
    ...
    $root.DrawState = (function() {
        ...
        DrawState.encode = function encode(message, writer) {
            ...
            if (message.color != null && Object.hasOwnProperty.call(message, "color"))
                $root.Color.encode(message.color, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        ...
        DrawState.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrawState();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        DrawState.fromObject = function fromObject(object) {
            if (object instanceof $root.DrawState)
                return object;
    ...
    $root.DrawBeginPath = (function() {
        ...
        DrawBeginPath.encode = function encode(message, writer) {
            ...
            if (message.state != null && Object.hasOwnProperty.call(message, "state"))
                $root.DrawState.encode(message.state, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
        ...
        DrawBeginPath.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrawBeginPath();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        DrawBeginPath.fromObject = function fromObject(object) {
            if (object instanceof $root.DrawBeginPath)
                return object;
    ...
    $root.DrawLineTo = (function() {
        ...
        DrawLineTo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrawLineTo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 4:
        ...
        DrawLineTo.fromObject = function fromObject(object) {
            if (object instanceof $root.DrawLineTo)
                return object;
    ...
    $root.DrawClosePath = (function() {
        ...
        DrawClosePath.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrawClosePath();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        DrawClosePath.fromObject = function fromObject(object) {
            if (object instanceof $root.DrawClosePath)
                return object;
    ...
    $root.DrawFill = (function() {
        ...
        DrawFill.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrawFill();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        DrawFill.fromObject = function fromObject(object) {
            if (object instanceof $root.DrawFill)
                return object;
    ...
    $root.DrawCommand = (function() {
        ...
        Object.defineProperty(DrawCommand.prototype, "command", {
            get: $util.oneOfGetter($oneOfFields = ["beginPath", "lineTo", "closePath", "fill"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        DrawCommand.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.beginPath != null && Object.hasOwnProperty.call(message, "beginPath"))
                $root.DrawBeginPath.encode(message.beginPath, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.lineTo != null && Object.hasOwnProperty.call(message, "lineTo"))
                $root.DrawLineTo.encode(message.lineTo, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.closePath != null && Object.hasOwnProperty.call(message, "closePath"))
                $root.DrawClosePath.encode(message.closePath, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.fill != null && Object.hasOwnProperty.call(message, "fill"))
                $root.DrawFill.encode(message.fill, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
        ...
        DrawCommand.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DrawCommand();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.beginPath = $root.DrawBeginPath.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.lineTo = $root.DrawLineTo.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.closePath = $root.DrawClosePath.decode(reader, reader.uint32());
                    break;
                case 4:
        ...
        DrawCommand.fromObject = function fromObject(object) {
            if (object instanceof $root.DrawCommand)
                return object;
        ...
        DrawCommand.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (message.beginPath != null && message.hasOwnProperty("beginPath")) {
                object.beginPath = $root.DrawBeginPath.toObject(message.beginPath, options);
                if (options.oneofs)
                    object.command = "beginPath";
            }
            if (message.lineTo != null && message.hasOwnProperty("lineTo")) {
                object.lineTo = $root.DrawLineTo.toObject(message.lineTo, options);
                if (options.oneofs)
                    object.command = "lineTo";
            }
            if (message.closePath != null && message.hasOwnProperty("closePath")) {
                object.closePath = $root.DrawClosePath.toObject(message.closePath, options);
                if (options.oneofs)
                    object.command = "closePath";
            }
            if (message.fill != null && message.hasOwnProperty("fill")) {
    ...
    $root.ServerMessage = (function() {
         ...
         * @property {ServerMessage.IKickedMessage|null} [kicked] ServerMessage kicked
         ...
         * @property {ServerMessage.IPlayerKickedMessage|null} [playerKicked] ServerMessage playerKicked
         ...
         * @property {ServerMessage.IShowLobbyMessage|null} [showLobby] ServerMessage showLobby
         ...
         * @member {ServerMessage.IKickedMessage|null|undefined} kicked
         * @memberof ServerMessage
         * @instance
         */
        ServerMessage.prototype.kicked = null;
         ...
         * @member {ServerMessage.IPlayerKickedMessage|null|undefined} playerKicked
         * @memberof ServerMessage
         * @instance
         */
        ...
        /**
         * ServerMessage showLobby.
         * @member {ServerMessage.IShowLobbyMessage|null|undefined} showLobby
         * @memberof ServerMessage
         * @instance
         */
        ServerMessage.prototype.showLobby = null;
         ...
         * @member {"chooseWord"|"clearCanvas"|"connected"|"currentWordUpdate"|"disconnected"|"kicked"|"playerConnected"|"playerDisconnected"|"playerKicked"|"playerGuessed"|"wordReveal"|"chatMessage"|"showLobby"|"gameStarted"|"updatePlayerDrawing"|"errorMessage"|undefined} message
         * @memberof ServerMessage
         * @instance
         */
        Object.defineProperty(ServerMessage.prototype, "message", {
            get: $util.oneOfGetter($oneOfFields = ["chooseWord", "clearCanvas", "connected", "currentWordUpdate", "disconnected", "kicked", "playerConnected", "playerDisconnected", "playerKicked", "playerGuessed", "wordReveal", "chatMessage", "showLobby", "gameStarted", "updatePlayerDrawing", "errorMessage"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        ServerMessage.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.chooseWord != null && Object.hasOwnProperty.call(message, "chooseWord"))
                $root.ServerMessage.ChooseWordMessage.encode(message.chooseWord, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.clearCanvas != null && Object.hasOwnProperty.call(message, "clearCanvas"))
                $root.ServerMessage.ClearCanvasMessage.encode(message.clearCanvas, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.connected != null && Object.hasOwnProperty.call(message, "connected"))
                $root.ServerMessage.ConnectedMessage.encode(message.connected, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.currentWordUpdate != null && Object.hasOwnProperty.call(message, "currentWordUpdate"))
                $root.ServerMessage.CurrentWordUpdateMessage.encode(message.currentWordUpdate, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.disconnected != null && Object.hasOwnProperty.call(message, "disconnected"))
                $root.ServerMessage.DisconnectedMessage.encode(message.disconnected, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.kicked != null && Object.hasOwnProperty.call(message, "kicked"))
                $root.ServerMessage.KickedMessage.encode(message.kicked, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            if (message.playerConnected != null && Object.hasOwnProperty.call(message, "playerConnected"))
                $root.ServerMessage.PlayerConnectedMessage.encode(message.playerConnected, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
            if (message.playerDisconnected != null && Object.hasOwnProperty.call(message, "playerDisconnected"))
                $root.ServerMessage.PlayerDisconnectedMessage.encode(message.playerDisconnected, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            if (message.playerKicked != null && Object.hasOwnProperty.call(message, "playerKicked"))
                $root.ServerMessage.PlayerKickedMessage.encode(message.playerKicked, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
            if (message.playerGuessed != null && Object.hasOwnProperty.call(message, "playerGuessed"))
                $root.ServerMessage.PlayerGuessedMessage.encode(message.playerGuessed, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
            if (message.wordReveal != null && Object.hasOwnProperty.call(message, "wordReveal"))
                $root.ServerMessage.WordRevealMessage.encode(message.wordReveal, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
            if (message.chatMessage != null && Object.hasOwnProperty.call(message, "chatMessage"))
                $root.ServerMessage.ChatMessage.encode(message.chatMessage, writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
            if (message.showLobby != null && Object.hasOwnProperty.call(message, "showLobby"))
                $root.ServerMessage.ShowLobbyMessage.encode(message.showLobby, writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
            if (message.gameStarted != null && Object.hasOwnProperty.call(message, "gameStarted"))
                $root.ServerMessage.GameStartedMessage.encode(message.gameStarted, writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
            if (message.updatePlayerDrawing != null && Object.hasOwnProperty.call(message, "updatePlayerDrawing"))
                $root.ServerMessage.UpdateDrawingPlayerMessage.encode(message.updatePlayerDrawing, writer.uint32(/* id 15, wireType 2 =*/122).fork()).ldelim();
            if (message.errorMessage != null && Object.hasOwnProperty.call(message, "errorMessage"))
                $root.ServerMessage.ErrorMessage.encode(message.errorMessage, writer.uint32(/* id 16, wireType 2 =*/130).fork()).ldelim();
            return writer;
        };
        ...
        ServerMessage.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1:
                    message.chooseWord = $root.ServerMessage.ChooseWordMessage.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.clearCanvas = $root.ServerMessage.ClearCanvasMessage.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.connected = $root.ServerMessage.ConnectedMessage.decode(reader, reader.uint32());
                    break;
                case 4:
                    message.currentWordUpdate = $root.ServerMessage.CurrentWordUpdateMessage.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.disconnected = $root.ServerMessage.DisconnectedMessage.decode(reader, reader.uint32());
                    break;
                case 6:
                    message.kicked = $root.ServerMessage.KickedMessage.decode(reader, reader.uint32());
                    break;
                case 7:
                    message.playerConnected = $root.ServerMessage.PlayerConnectedMessage.decode(reader, reader.uint32());
                    break;
                case 8:
                    message.playerDisconnected = $root.ServerMessage.PlayerDisconnectedMessage.decode(reader, reader.uint32());
                    break;
                case 9:
                    message.playerKicked = $root.ServerMessage.PlayerKickedMessage.decode(reader, reader.uint32());
                    break;
                case 10:
                    message.playerGuessed = $root.ServerMessage.PlayerGuessedMessage.decode(reader, reader.uint32());
                    break;
                case 11:
                    message.wordReveal = $root.ServerMessage.WordRevealMessage.decode(reader, reader.uint32());
                    break;
                case 12:
                    message.chatMessage = $root.ServerMessage.ChatMessage.decode(reader, reader.uint32());
                    break;
                case 13:
                    message.showLobby = $root.ServerMessage.ShowLobbyMessage.decode(reader, reader.uint32());
                    break;
                case 14:
                    message.gameStarted = $root.ServerMessage.GameStartedMessage.decode(reader, reader.uint32());
                    break;
                case 15:
                    message.updatePlayerDrawing = $root.ServerMessage.UpdateDrawingPlayerMessage.decode(reader, reader.uint32());
                    break;
                case 16:
                    message.errorMessage = $root.ServerMessage.ErrorMessage.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        ServerMessage.verify = function verify(message) {
            ...
            if (message.chooseWord != null && message.hasOwnProperty("chooseWord")) {
                properties.message = 1;
                {
                    var error = $root.ServerMessage.ChooseWordMessage.verify(message.chooseWord);
                    if (error)
                        return "chooseWord." + error;
                }
            }
            if (message.clearCanvas != null && message.hasOwnProperty("clearCanvas")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.ClearCanvasMessage.verify(message.clearCanvas);
                    if (error)
                        return "clearCanvas." + error;
                }
            }
            if (message.connected != null && message.hasOwnProperty("connected")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.ConnectedMessage.verify(message.connected);
                    if (error)
                        return "connected." + error;
                }
            }
            if (message.currentWordUpdate != null && message.hasOwnProperty("currentWordUpdate")) {
                if (properties.message === 1)
                    return "message: multiple values";
                properties.message = 1;
                {
                    var error = $root.ServerMessage.CurrentWordUpdateMessage.verify(message.currentWordUpdate);
                    if (error)
                        return "currentWordUpdate." + error;
                }
            }
            if (message.disconnected != null && message.hasOwnProperty("disconnected")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.DisconnectedMessage.verify(message.disconnected);
                    if (error)
            ...
            if (message.kicked != null && message.hasOwnProperty("kicked")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.KickedMessage.verify(message.kicked);
                    if (error)
                        return "kicked." + error;
                }
            }
            if (message.playerConnected != null && message.hasOwnProperty("playerConnected")) {
                if (properties.message === 1)
                    return "message: multiple values";
                properties.message = 1;
                {
                    var error = $root.ServerMessage.PlayerConnectedMessage.verify(message.playerConnected);
                    if (error)
                        return "playerConnected." + error;
                }
            }
            if (message.playerDisconnected != null && message.hasOwnProperty("playerDisconnected")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.PlayerDisconnectedMessage.verify(message.playerDisconnected);
                    if (error)
            ...
            if (message.playerKicked != null && message.hasOwnProperty("playerKicked")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.PlayerKickedMessage.verify(message.playerKicked);
                    if (error)
                        return "playerKicked." + error;
                }
            }
            if (message.playerGuessed != null && message.hasOwnProperty("playerGuessed")) {
                if (properties.message === 1)
                    return "message: multiple values";
                properties.message = 1;
                {
                    var error = $root.ServerMessage.PlayerGuessedMessage.verify(message.playerGuessed);
                    if (error)
                        return "playerGuessed." + error;
                }
            }
            if (message.wordReveal != null && message.hasOwnProperty("wordReveal")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.WordRevealMessage.verify(message.wordReveal);
                    if (error)
                        return "wordReveal." + error;
                }
            }
            if (message.chatMessage != null && message.hasOwnProperty("chatMessage")) {
                if (properties.message === 1)
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.ChatMessage.verify(message.chatMessage);
                    if (error)
                        return "chatMessage." + error;
                }
            }
            if (message.showLobby != null && message.hasOwnProperty("showLobby")) {
                if (properties.message === 1)
                    return "message: multiple values";
                properties.message = 1;
                {
                    var error = $root.ServerMessage.ShowLobbyMessage.verify(message.showLobby);
                    if (error)
                        return "showLobby." + error;
                }
            }
            if (message.gameStarted != null && message.hasOwnProperty("gameStarted")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.GameStartedMessage.verify(message.gameStarted);
                    if (error)
                        return "gameStarted." + error;
                }
            }
            if (message.updatePlayerDrawing != null && message.hasOwnProperty("updatePlayerDrawing")) {
                if (properties.message === 1)
                    return "message: multiple values";
                properties.message = 1;
                {
                    var error = $root.ServerMessage.UpdateDrawingPlayerMessage.verify(message.updatePlayerDrawing);
                    if (error)
                        return "updatePlayerDrawing." + error;
                }
            }
            if (message.errorMessage != null && message.hasOwnProperty("errorMessage")) {
                ...
                properties.message = 1;
                {
                    var error = $root.ServerMessage.ErrorMessage.verify(message.errorMessage);
                    if (error)
        ...
        ServerMessage.fromObject = function fromObject(object) {
            ...
            if (object.chooseWord != null) {
                ...
                message.chooseWord = $root.ServerMessage.ChooseWordMessage.fromObject(object.chooseWord);
            }
            if (object.clearCanvas != null) {
                if (typeof object.clearCanvas !== "object")
                    throw TypeError(".ServerMessage.clearCanvas: object expected");
                message.clearCanvas = $root.ServerMessage.ClearCanvasMessage.fromObject(object.clearCanvas);
            }
            if (object.connected != null) {
                if (typeof object.connected !== "object")
                    throw TypeError(".ServerMessage.connected: object expected");
                message.connected = $root.ServerMessage.ConnectedMessage.fromObject(object.connected);
            }
            if (object.currentWordUpdate != null) {
                ...
                message.currentWordUpdate = $root.ServerMessage.CurrentWordUpdateMessage.fromObject(object.currentWordUpdate);
            }
            if (object.disconnected != null) {
                ...
                message.disconnected = $root.ServerMessage.DisconnectedMessage.fromObject(object.disconnected);
            }
            if (object.kicked != null) {
                if (typeof object.kicked !== "object")
                    throw TypeError(".ServerMessage.kicked: object expected");
                message.kicked = $root.ServerMessage.KickedMessage.fromObject(object.kicked);
            }
            if (object.playerConnected != null) {
                ...
                message.playerConnected = $root.ServerMessage.PlayerConnectedMessage.fromObject(object.playerConnected);
            }
            if (object.playerDisconnected != null) {
                ...
                message.playerDisconnected = $root.ServerMessage.PlayerDisconnectedMessage.fromObject(object.playerDisconnected);
            }
            if (object.playerKicked != null) {
                if (typeof object.playerKicked !== "object")
                    throw TypeError(".ServerMessage.playerKicked: object expected");
                message.playerKicked = $root.ServerMessage.PlayerKickedMessage.fromObject(object.playerKicked);
            }
            if (object.playerGuessed != null) {
                ...
                message.playerGuessed = $root.ServerMessage.PlayerGuessedMessage.fromObject(object.playerGuessed);
            }
            if (object.wordReveal != null) {
                if (typeof object.wordReveal !== "object")
                    throw TypeError(".ServerMessage.wordReveal: object expected");
                message.wordReveal = $root.ServerMessage.WordRevealMessage.fromObject(object.wordReveal);
            }
            if (object.chatMessage != null) {
                if (typeof object.chatMessage !== "object")
                    throw TypeError(".ServerMessage.chatMessage: object expected");
                message.chatMessage = $root.ServerMessage.ChatMessage.fromObject(object.chatMessage);
            }
            if (object.showLobby != null) {
                if (typeof object.showLobby !== "object")
                    throw TypeError(".ServerMessage.showLobby: object expected");
                message.showLobby = $root.ServerMessage.ShowLobbyMessage.fromObject(object.showLobby);
            }
            if (object.gameStarted != null) {
                if (typeof object.gameStarted !== "object")
                    throw TypeError(".ServerMessage.gameStarted: object expected");
                message.gameStarted = $root.ServerMessage.GameStartedMessage.fromObject(object.gameStarted);
            }
            if (object.updatePlayerDrawing != null) {
                if (typeof object.updatePlayerDrawing !== "object")
                    throw TypeError(".ServerMessage.updatePlayerDrawing: object expected");
                message.updatePlayerDrawing = $root.ServerMessage.UpdateDrawingPlayerMessage.fromObject(object.updatePlayerDrawing);
            }
            if (object.errorMessage != null) {
                if (typeof object.errorMessage !== "object")
                    throw TypeError(".ServerMessage.errorMessage: object expected");
                message.errorMessage = $root.ServerMessage.ErrorMessage.fromObject(object.errorMessage);
            }
            return message;
        };
        ...
        ServerMessage.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (message.chooseWord != null && message.hasOwnProperty("chooseWord")) {
                object.chooseWord = $root.ServerMessage.ChooseWordMessage.toObject(message.chooseWord, options);
                if (options.oneofs)
                    object.message = "chooseWord";
            }
            if (message.clearCanvas != null && message.hasOwnProperty("clearCanvas")) {
                object.clearCanvas = $root.ServerMessage.ClearCanvasMessage.toObject(message.clearCanvas, options);
                if (options.oneofs)
                    object.message = "clearCanvas";
            }
            if (message.connected != null && message.hasOwnProperty("connected")) {
                object.connected = $root.ServerMessage.ConnectedMessage.toObject(message.connected, options);
                if (options.oneofs)
                    object.message = "connected";
            }
            if (message.currentWordUpdate != null && message.hasOwnProperty("currentWordUpdate")) {
                object.currentWordUpdate = $root.ServerMessage.CurrentWordUpdateMessage.toObject(message.currentWordUpdate, options);
                if (options.oneofs)
                    object.message = "currentWordUpdate";
            }
            if (message.disconnected != null && message.hasOwnProperty("disconnected")) {
                object.disconnected = $root.ServerMessage.DisconnectedMessage.toObject(message.disconnected, options);
                if (options.oneofs)
                    object.message = "disconnected";
            }
            if (message.kicked != null && message.hasOwnProperty("kicked")) {
                object.kicked = $root.ServerMessage.KickedMessage.toObject(message.kicked, options);
                if (options.oneofs)
                    object.message = "kicked";
            }
            if (message.playerConnected != null && message.hasOwnProperty("playerConnected")) {
                object.playerConnected = $root.ServerMessage.PlayerConnectedMessage.toObject(message.playerConnected, options);
                if (options.oneofs)
                    object.message = "playerConnected";
            }
            if (message.playerDisconnected != null && message.hasOwnProperty("playerDisconnected")) {
                object.playerDisconnected = $root.ServerMessage.PlayerDisconnectedMessage.toObject(message.playerDisconnected, options);
                if (options.oneofs)
                    object.message = "playerDisconnected";
            }
            if (message.playerKicked != null && message.hasOwnProperty("playerKicked")) {
                object.playerKicked = $root.ServerMessage.PlayerKickedMessage.toObject(message.playerKicked, options);
                if (options.oneofs)
                    object.message = "playerKicked";
            }
            if (message.playerGuessed != null && message.hasOwnProperty("playerGuessed")) {
                object.playerGuessed = $root.ServerMessage.PlayerGuessedMessage.toObject(message.playerGuessed, options);
                if (options.oneofs)
                    object.message = "playerGuessed";
            }
            if (message.wordReveal != null && message.hasOwnProperty("wordReveal")) {
                object.wordReveal = $root.ServerMessage.WordRevealMessage.toObject(message.wordReveal, options);
                if (options.oneofs)
                    object.message = "wordReveal";
            }
            if (message.chatMessage != null && message.hasOwnProperty("chatMessage")) {
                object.chatMessage = $root.ServerMessage.ChatMessage.toObject(message.chatMessage, options);
                if (options.oneofs)
                    object.message = "chatMessage";
            }
            if (message.showLobby != null && message.hasOwnProperty("showLobby")) {
                object.showLobby = $root.ServerMessage.ShowLobbyMessage.toObject(message.showLobby, options);
                if (options.oneofs)
                    object.message = "showLobby";
            }
            if (message.gameStarted != null && message.hasOwnProperty("gameStarted")) {
                object.gameStarted = $root.ServerMessage.GameStartedMessage.toObject(message.gameStarted, options);
                if (options.oneofs)
                    object.message = "gameStarted";
            }
            if (message.updatePlayerDrawing != null && message.hasOwnProperty("updatePlayerDrawing")) {
                object.updatePlayerDrawing = $root.ServerMessage.UpdateDrawingPlayerMessage.toObject(message.updatePlayerDrawing, options);
                if (options.oneofs)
                    object.message = "updatePlayerDrawing";
            }
            if (message.errorMessage != null && message.hasOwnProperty("errorMessage")) {
                object.errorMessage = $root.ServerMessage.ErrorMessage.toObject(message.errorMessage, options);
                if (options.oneofs)
        ...
        ServerMessage.ChooseWordMessage = (function() {
             ...
             * @memberof ServerMessage
             * @interface IChooseWordMessage
             * @property {number|null} [playerId] ChooseWordMessage playerId
             ...
             * @instance
             */
            ChooseWordMessage.prototype.playerId = 0;
            ...
            ChooseWordMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.ChooseWordMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ChooseWordMessage.fromObject = function fromObject(object) {
                ...
                if (object.words) {
                    if (!Array.isArray(object.words))
                        throw TypeError(".ServerMessage.ChooseWordMessage.words: array expected");
                    message.words = [];
        ...
        ServerMessage.ClearCanvasMessage = (function() {
            ...
            ClearCanvasMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.ClearCanvasMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
        ...
        ServerMessage.ConnectedMessage = (function() {
            ...
            ConnectedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.ConnectedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
        ...
        ServerMessage.CurrentWordUpdateMessage = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            CurrentWordUpdateMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            CurrentWordUpdateMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.CurrentWordUpdateMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CurrentWordUpdateMessage.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
        ...
        ServerMessage.DisconnectedMessage = (function() {
            ...
            DisconnectedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.DisconnectedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
        ...
        ServerMessage.DrawMessage = (function() {
            ...
            DrawMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.DrawMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
             ...
             */
            DrawMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ServerMessage.DrawMessage)
                    return object;
                var message = new $root.ServerMessage.DrawMessage();
                if (object.commands) {
                    if (!Array.isArray(object.commands))
                        throw TypeError(".ServerMessage.DrawMessage.commands: array expected");
                    message.commands = [];
                    for (var i = 0; i < object.commands.length; ++i) {
                        if (typeof object.commands[i] !== "object")
                            throw TypeError(".ServerMessage.DrawMessage.commands: object expected");
                        message.commands[i] = $root.DrawCommand.fromObject(object.commands[i]);
                    }
                }
                return message;
        ...
        ServerMessage.KickedMessage = (function() {
    
            /**
             * Properties of a KickedMessage.
             * @memberof ServerMessage
             * @interface IKickedMessage
             */
    
            /**
             * Constructs a new KickedMessage.
             * @memberof ServerMessage
             * @classdesc Represents a KickedMessage.
             * @implements IKickedMessage
             * @constructor
             * @param {ServerMessage.IKickedMessage=} [properties] Properties to set
             */
            function KickedMessage(properties) {
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
            ...
            /**
             * Creates a new KickedMessage instance using the specified properties.
             * @function create
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {ServerMessage.IKickedMessage=} [properties] Properties to set
             * @returns {ServerMessage.KickedMessage} KickedMessage instance
             */
            KickedMessage.create = function create(properties) {
                return new KickedMessage(properties);
            };
    
            /**
             * Encodes the specified KickedMessage message. Does not implicitly {@link ServerMessage.KickedMessage.verify|verify} messages.
             * @function encode
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {ServerMessage.IKickedMessage} message KickedMessage message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            KickedMessage.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                return writer;
            };
            ...
            /**
             * Encodes the specified KickedMessage message, length delimited. Does not implicitly {@link ServerMessage.KickedMessage.verify|verify} messages.
             * @function encodeDelimited
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {ServerMessage.IKickedMessage} message KickedMessage message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            KickedMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
    
            /**
             * Decodes a KickedMessage message from the specified reader or buffer.
             * @function decode
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {ServerMessage.KickedMessage} KickedMessage
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            KickedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.KickedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
            ...
            /**
             * Decodes a KickedMessage message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            KickedMessage.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            /**
             * Verifies a KickedMessage message.
             * @function verify
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {Object.<string,*>} message Plain object to verify
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            KickedMessage.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                return null;
            };
            ...
            /**
             * Creates a KickedMessage message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {ServerMessage.KickedMessage} KickedMessage
             */
            KickedMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ServerMessage.KickedMessage)
                    return object;
                return new $root.ServerMessage.KickedMessage();
            };
    
            /**
             * Creates a plain object from a KickedMessage message. Also converts values to other types if specified.
             * @function toObject
             * @memberof ServerMessage.KickedMessage
             * @static
             * @param {ServerMessage.KickedMessage} message KickedMessage
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            KickedMessage.toObject = function toObject() {
                return {};
            };
    
            /**
             * Converts this KickedMessage to JSON.
             * @function toJSON
             * @memberof ServerMessage.KickedMessage
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            KickedMessage.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };
        ...
        ServerMessage.PlayerConnectedMessage = (function() {
             ...
             * @property {number|null} [playerId] PlayerConnectedMessage playerId
             ...
             * @instance
             */
            PlayerConnectedMessage.prototype.playerId = 0;
            ...
            PlayerConnectedMessage.encode = function encode(message, writer) {
                ...
                if (message.guessedWord != null && Object.hasOwnProperty.call(message, "guessedWord"))
             ...
             * @returns {$protobuf.Writer} Writer
             */
            PlayerConnectedMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            PlayerConnectedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.PlayerConnectedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            PlayerConnectedMessage.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            PlayerConnectedMessage.verify = function verify(message) {
                ...
                if (message.guessedWord != null && message.hasOwnProperty("guessedWord"))
        ...
        ServerMessage.PlayerDisconnectedMessage = (function() {
             ...
             * @property {number|null} [playerId] PlayerDisconnectedMessage playerId
             */
             ...
             * @instance
             */
            PlayerDisconnectedMessage.prototype.playerId = 0;
             ...
             * @returns {$protobuf.Writer} Writer
             */
            PlayerDisconnectedMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            PlayerDisconnectedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.PlayerDisconnectedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            PlayerDisconnectedMessage.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
        ...
        ServerMessage.PlayerKickedMessage = (function() {
    
            /**
             * Properties of a PlayerKickedMessage.
             * @memberof ServerMessage
             * @interface IPlayerKickedMessage
             * @property {number|null} [playerId] PlayerKickedMessage playerId
             */
    
            /**
             * Constructs a new PlayerKickedMessage.
             * @memberof ServerMessage
             * @classdesc Represents a PlayerKickedMessage.
             * @implements IPlayerKickedMessage
             * @constructor
             * @param {ServerMessage.IPlayerKickedMessage=} [properties] Properties to set
             */
            function PlayerKickedMessage(properties) {
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
            ...
            /**
             * PlayerKickedMessage playerId.
             * @member {number} playerId
             * @memberof ServerMessage.PlayerKickedMessage
             * @instance
             */
            PlayerKickedMessage.prototype.playerId = 0;
    
            /**
             * Creates a new PlayerKickedMessage instance using the specified properties.
             * @function create
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {ServerMessage.IPlayerKickedMessage=} [properties] Properties to set
             * @returns {ServerMessage.PlayerKickedMessage} PlayerKickedMessage instance
             */
            PlayerKickedMessage.create = function create(properties) {
                return new PlayerKickedMessage(properties);
            };
    
            /**
             * Encodes the specified PlayerKickedMessage message. Does not implicitly {@link ServerMessage.PlayerKickedMessage.verify|verify} messages.
             * @function encode
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {ServerMessage.IPlayerKickedMessage} message PlayerKickedMessage message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            PlayerKickedMessage.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.playerId != null && Object.hasOwnProperty.call(message, "playerId"))
                    writer.uint32(/* id 1, wireType 0 =*/8).int32(message.playerId);
            ...
            /**
             * Encodes the specified PlayerKickedMessage message, length delimited. Does not implicitly {@link ServerMessage.PlayerKickedMessage.verify|verify} messages.
             * @function encodeDelimited
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {ServerMessage.IPlayerKickedMessage} message PlayerKickedMessage message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            PlayerKickedMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
    
            /**
             * Decodes a PlayerKickedMessage message from the specified reader or buffer.
             * @function decode
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {ServerMessage.PlayerKickedMessage} PlayerKickedMessage
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            PlayerKickedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.PlayerKickedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            /**
             * Decodes a PlayerKickedMessage message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            PlayerKickedMessage.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            /**
             * Verifies a PlayerKickedMessage message.
             * @function verify
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {Object.<string,*>} message Plain object to verify
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            PlayerKickedMessage.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.playerId != null && message.hasOwnProperty("playerId"))
                    if (!$util.isInteger(message.playerId))
            ...
            /**
             * Creates a PlayerKickedMessage message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {ServerMessage.PlayerKickedMessage} PlayerKickedMessage
             */
            PlayerKickedMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ServerMessage.PlayerKickedMessage)
                    return object;
                var message = new $root.ServerMessage.PlayerKickedMessage();
                if (object.playerId != null)
                    message.playerId = object.playerId | 0;
                return message;
            };
            ...
            /**
             * Creates a plain object from a PlayerKickedMessage message. Also converts values to other types if specified.
             * @function toObject
             * @memberof ServerMessage.PlayerKickedMessage
             * @static
             * @param {ServerMessage.PlayerKickedMessage} message PlayerKickedMessage
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            PlayerKickedMessage.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.defaults)
            ...
            /**
             * Converts this PlayerKickedMessage to JSON.
             * @function toJSON
             * @memberof ServerMessage.PlayerKickedMessage
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            PlayerKickedMessage.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };
        ...
        ServerMessage.PlayerGuessedMessage = (function() {
             ...
             * @property {number|null} [playerId] PlayerGuessedMessage playerId
             */
             ...
             * @instance
             */
            PlayerGuessedMessage.prototype.playerId = 0;
             ...
             * @returns {$protobuf.Writer} Writer
             */
            PlayerGuessedMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            PlayerGuessedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.PlayerGuessedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
        ...
        ServerMessage.WordRevealMessage = (function() {
            ...
            WordRevealMessage.encode = function encode(message, writer) {
                ...
                if (message.scores != null && message.scores.length)
                    for (var i = 0; i < message.scores.length; ++i)
                        $root.ServerMessage.WordRevealMessage.PlayerScore.encode(message.scores[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                return writer;
            };
             ...
             * @returns {$protobuf.Writer} Writer
             */
            WordRevealMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            WordRevealMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.WordRevealMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
                    ...
                    case 3:
                        if (!(message.scores && message.scores.length))
                            message.scores = [];
                        message.scores.push($root.ServerMessage.WordRevealMessage.PlayerScore.decode(reader, reader.uint32()));
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            WordRevealMessage.verify = function verify(message) {
                ...
                if (message.scores != null && message.hasOwnProperty("scores")) {
                    ...
                    for (var i = 0; i < message.scores.length; ++i) {
                        var error = $root.ServerMessage.WordRevealMessage.PlayerScore.verify(message.scores[i]);
                        if (error)
                            return "scores." + error;
                    }
                }
            ...
            WordRevealMessage.fromObject = function fromObject(object) {
                ...
                if (object.scores) {
                    if (!Array.isArray(object.scores))
                        throw TypeError(".ServerMessage.WordRevealMessage.scores: array expected");
                    message.scores = [];
                    for (var i = 0; i < object.scores.length; ++i) {
                        if (typeof object.scores[i] !== "object")
                            throw TypeError(".ServerMessage.WordRevealMessage.scores: object expected");
                        message.scores[i] = $root.ServerMessage.WordRevealMessage.PlayerScore.fromObject(object.scores[i]);
                    }
                }
                return message;
            };
            ...
            WordRevealMessage.toObject = function toObject(message, options) {
                ...
                if (message.reason != null && message.hasOwnProperty("reason"))
                    object.reason = options.enums === String ? $root.ServerMessage.WordRevealMessage.RevealReason[message.reason] : message.reason;
                if (message.word != null && message.hasOwnProperty("word"))
                    object.word = message.word;
                if (message.scores && message.scores.length) {
                    object.scores = [];
                    for (var j = 0; j < message.scores.length; ++j)
                        object.scores[j] = $root.ServerMessage.WordRevealMessage.PlayerScore.toObject(message.scores[j], options);
                }
                return object;
            };
            ...
            WordRevealMessage.PlayerScore = (function() {
                ...
                PlayerScore.encode = function encode(message, writer) {
                    ...
                    if (message.playerId != null && Object.hasOwnProperty.call(message, "playerId"))
                        writer.uint32(/* id 1, wireType 0 =*/8).int32(message.playerId);
                    if (message.playerScore != null && Object.hasOwnProperty.call(message, "playerScore"))
                        writer.uint32(/* id 2, wireType 0 =*/16).int32(message.playerScore);
                    return writer;
                };
                ...
                PlayerScore.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.WordRevealMessage.PlayerScore();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                PlayerScore.fromObject = function fromObject(object) {
                    if (object instanceof $root.ServerMessage.WordRevealMessage.PlayerScore)
                        return object;
        ...
        ServerMessage.ChatMessage = (function() {
            ...
            ChatMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.ChatMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
             ...
             */
            ChatMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ServerMessage.ChatMessage)
                    return object;
        ...
        ServerMessage.ErrorMessage = (function() {
            ...
            ErrorMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.ErrorMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            ErrorMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ServerMessage.ErrorMessage)
                    return object;
        ...
        ServerMessage.ShowLobbyMessage = (function() {
    
            /**
             * Properties of a ShowLobbyMessage.
             * @memberof ServerMessage
             * @interface IShowLobbyMessage
             * @property {string|null} [roomId] ShowLobbyMessage roomId
             */
    
            /**
             * Constructs a new ShowLobbyMessage.
             * @memberof ServerMessage
             * @classdesc Represents a ShowLobbyMessage.
             * @implements IShowLobbyMessage
             * @constructor
             * @param {ServerMessage.IShowLobbyMessage=} [properties] Properties to set
             */
            function ShowLobbyMessage(properties) {
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
            ...
            /**
             * ShowLobbyMessage roomId.
             * @member {string} roomId
             * @memberof ServerMessage.ShowLobbyMessage
             * @instance
             */
            ShowLobbyMessage.prototype.roomId = "";
    
            /**
             * Creates a new ShowLobbyMessage instance using the specified properties.
             * @function create
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {ServerMessage.IShowLobbyMessage=} [properties] Properties to set
             * @returns {ServerMessage.ShowLobbyMessage} ShowLobbyMessage instance
             */
            ShowLobbyMessage.create = function create(properties) {
                return new ShowLobbyMessage(properties);
            };
    
            /**
             * Encodes the specified ShowLobbyMessage message. Does not implicitly {@link ServerMessage.ShowLobbyMessage.verify|verify} messages.
             * @function encode
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {ServerMessage.IShowLobbyMessage} message ShowLobbyMessage message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ShowLobbyMessage.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.roomId != null && Object.hasOwnProperty.call(message, "roomId"))
            ...
            /**
             * Encodes the specified ShowLobbyMessage message, length delimited. Does not implicitly {@link ServerMessage.ShowLobbyMessage.verify|verify} messages.
             * @function encodeDelimited
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {ServerMessage.IShowLobbyMessage} message ShowLobbyMessage message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            ShowLobbyMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
    
            /**
             * Decodes a ShowLobbyMessage message from the specified reader or buffer.
             * @function decode
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {ServerMessage.ShowLobbyMessage} ShowLobbyMessage
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            ShowLobbyMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.ShowLobbyMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            /**
             * Decodes a ShowLobbyMessage message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            ShowLobbyMessage.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            /**
             * Verifies a ShowLobbyMessage message.
             * @function verify
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {Object.<string,*>} message Plain object to verify
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            ShowLobbyMessage.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.roomId != null && message.hasOwnProperty("roomId"))
                    if (!$util.isString(message.roomId))
            ...
            /**
             * Creates a ShowLobbyMessage message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {ServerMessage.ShowLobbyMessage} ShowLobbyMessage
             */
            ShowLobbyMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.ServerMessage.ShowLobbyMessage)
                    return object;
                var message = new $root.ServerMessage.ShowLobbyMessage();
                if (object.roomId != null)
                    message.roomId = String(object.roomId);
                return message;
            };
            ...
            /**
             * Creates a plain object from a ShowLobbyMessage message. Also converts values to other types if specified.
             * @function toObject
             * @memberof ServerMessage.ShowLobbyMessage
             * @static
             * @param {ServerMessage.ShowLobbyMessage} message ShowLobbyMessage
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            ShowLobbyMessage.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.defaults)
            ...
            /**
             * Converts this ShowLobbyMessage to JSON.
             * @function toJSON
             * @memberof ServerMessage.ShowLobbyMessage
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            ShowLobbyMessage.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };
    
            return ShowLobbyMessage;
        })();
        ...
        ServerMessage.GameStartedMessage = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            GameStartedMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            GameStartedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.GameStartedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
        ...
        ServerMessage.UpdateDrawingPlayerMessage = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            UpdateDrawingPlayerMessage.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            UpdateDrawingPlayerMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ServerMessage.UpdateDrawingPlayerMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            UpdateDrawingPlayerMessage.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
